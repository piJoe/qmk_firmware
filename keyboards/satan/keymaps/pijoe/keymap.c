...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	XXXXXXX, KC_LGUI,KC_LALT,                        LT_SPCMOUS,                     KC_RALT,MO(_FUNC),XXXXXXX,  TO(_ESHFT)),
	...
	KC_LCTL,    M_ARR,  XXXXXXX,XXXXXXX,M_FUNC, DF(_GAME),XXXXXXX,XXXXXXX,XXXXXXX,M_LET,  XXXXXXX, XXXXXXX,            KC_ENT,  \
	...
	XXXXXXX,   KC_LGUI,      XXXXXXX,                                LT_SPCMOUS,                                 XXXXXXX,  XXXXXXX, XXXXXXX,  TG(_EDIT)),
	...
	KC_LCTL, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,            KC_ENT,  \
	KC_LSFT,         KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,            KC_RSFT, \
	XXXXXXX, XXXXXXX,KC_LALT,                        KC_SPACE,                     	 KC_RALT,XXXXXXX,  XXXXXXX,  DF(_BASE)),
